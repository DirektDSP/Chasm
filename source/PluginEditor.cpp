...
void PluginEditor::setupSlider (juce::Slider& slider, juce::Label& label, const juce::String& labelText, const juce::String& suffix)
{
    ...
    if (
        labelText == "Mix" || labelText == "Width" || labelText == "In Gain" || labelText == "Boost" || labelText == "Haas")
    {
...
void PluginEditor::layoutSliderWithLabel (juce::Slider& slider, juce::Label& label, juce::Rectangle<int> area)
{
    auto labelHeight = 20;
...
void PluginEditor::layoutToggleWithLabel (juce::ToggleButton& button, juce::Label& label, juce::Rectangle<int> area)
{
    auto labelHeight = 20;
    label.setBounds (area.removeFromTop (labelHeight));
