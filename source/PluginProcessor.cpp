    ...
    juce::MidiBuffer& midiMessages)
{
    ...
    dspProcessor.updateParameters (inputGain, outputGain, mix, delay, brightness, character, lowCut, highCut, width, mil_InputGain, mil_BoostValue, mil_Mode, haasAmount);
